...
** TODO Initial distance values may be too big for non-stock
- Check real scale makes sense in real life, see if stock works (1/10th)
** TODO Check real scale rewards are not scaled too high
- First contract would be 100 science
- Perhaps science and rep are not scaled, probably as contracts are for money
- Possibly some or all are sqrt(scale), ie.
  - KSRSS would be 1.6x (16)
  - RSS would be 3x (30)
